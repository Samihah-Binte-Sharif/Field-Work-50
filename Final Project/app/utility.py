...
def generate_summary(news_body):
    client = Groq(api_key='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')
    chat_completion = client.chat.completions.create(
        model="llama-3.3-70b-versatile",
        messages=[
            {
                "role": "system",
                "content": "You are an expert in news summarization in bengali languages. Please summarize the following news article in top  3 to 5 bullet points in the bengali language that you get."
            },
            {
                "role": "user",
                "content": news_body
